...
public class ModifyThemaOkCommand implements Command {
	...
	public void excute(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		themadto.setThem_code(Integer.parseInt(multipartRequest.getParameter("code")));
		...
		themadao.modifyThemaOk(themadto);
	}
